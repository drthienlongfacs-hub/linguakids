...
export const SPEAKING_LESSONS = [
    ...
    },
    {
        ...
        mode: 'adult',
        sentences: [
            { text: "The intense corporate rivalry between the two tech giants rapidly degenerated into mutual animosity, culminating in a series of hostile public smear campaigns.", textVi: "Sự cạnh tranh khốc liệt giữa hai gã khổng lồ công nghệ đã nhanh chóng thoái hóa thành sự thù hằn lẫn nhau, đỉnh điểm là một chuỗi các chiến dịch bôi nhọ công khai đầy thù địch." },
            { text: "Operating successfully in highly collectivistic cultures requires PR practitioners to recognize that social dynamics fundamentally prioritize group cohesion over individual autonomy.", textVi: "Hoạt động thành công trong các nền văn hóa có tính tập thể cao đòi hỏi những người làm PR phải nhận thức được rằng động lực xã hội về cơ bản ưu tiên sự gắn kết nhóm hơn là quyền tự chủ cá nhân." },
            { text: "Issues placement differs from traditional product placement because it primarily focuses on leveraging fictional narratives to foster public awareness around critical social issues.", textVi: "Lồng ghép vấn đề khác với lồng ghép sản phẩm truyền thống vì nó chủ yếu tập trung vào việc tận dụng các cốt truyện hư cấu để nâng cao nhận thức của công chúng về các vấn đề xã hội quan trọng." },
            { text: "The ubiquitous adoption of smartphones has fundamentally revolutionized public relations, enabling real-time, two-way symmetrical communication between brands and global stakeholders.", textVi: "Sự phổ cập của điện thoại thông minh đã thay đổi hoàn toàn quan hệ công chúng, cho phép giao tiếp đối xứng hai chiều trong thời gian thực giữa các thương hiệu và các bên liên quan trên toàn cầu." },
            { text: "The corporation faced severe litigation after a court ruled that using a celebrity's likeness in a commercial campaign without prior authorization constituted misappropriation of personality.", textVi: "Tập đoàn đã phải đối mặt với vụ kiện tụng nghiêm trọng sau khi tòa án phán quyết rằng việc sử dụng hình ảnh của người nổi tiếng trong chiến dịch quảng cáo mà không được phép trước cấu thành hành vi chiếm đoạt hình ảnh cá nhân." },
            { text: "The PR director faced a profound ethical dilemma when forced to choose between protecting client confidentiality and disclosing an imminent public safety hazard.", textVi: "Giám đốc PR đã phải đối mặt với một thế lưỡng nan sâu sắc về đạo đức khi buộc phải lựa chọn giữa việc bảo vệ bí mật khách hàng và tiết lộ mối nguy hiểm cận kề đối với an toàn công cộng." },
            { text: "To foster public awareness regarding a new national health initiative, the government body distributed a Public Service Announcement to major television networks for uncompensated broadcast.", textVi: "Để nâng cao nhận thức của công chúng về một sáng kiến y tế quốc gia mới, cơ quan chính phủ đã gửi một Thông điệp dịch vụ công ích đến các mạng truyền hình lớn để phát sóng miễn phí." },
            { text: "By falsely claiming that a competitor's medical equipment was defective, the firm committed trade libel, severely damaging the competitor's market share.", textVi: "Bằng cách tuyên bố sai sự thật rằng thiết bị y tế của đối thủ cạnh tranh bị lỗi, công ty đã phạm tội bôi nhọ thương mại, gây thiệt hại nghiêm trọng đến thị phần của đối thủ." },
            { text: "Integrating a brand's flagship smartphone seamlessly into the storyline of a blockbuster movie best exemplifies the strategic practice of product placement.", textVi: "Việc tích hợp liền mạch chiếc điện thoại thông minh chủ lực của thương hiệu vào cốt truyện của một bộ phim bom tấn là ví dụ điển hình nhất cho hoạt động chiến lược lồng ghép sản phẩm." },
            { text: "Incorporating a high-resolution infographic or a dynamic digital chart serves as an effective visual aid to clarify intricate statistical data during an investor relations meeting.", textVi: "Việc kết hợp một đồ họa thông tin độ phân giải cao hoặc một biểu đồ số động đóng vai trò như một công cụ trực quan hiệu quả để làm rõ dữ liệu thống kê phức tạp trong cuộc họp quan hệ cổ đông." },
            { text: "Because the consultancy failed to anticipate impending regulatory policy shifts accurately, the client was caught completely unprepared for the sudden market downturn.", textVi: "Vì công ty tư vấn không dự báo chính xác những thay đổi chính sách pháp lý sắp tới, khách hàng đã hoàn toàn bị động trước sự suy thoái đột ngột của thị trường." },
            { text: "A chamber of commerce is best defined as a localized coalition of business proprietors and corporate enterprises organized to advocate for economic growth.", textVi: "Phòng thương mại được định nghĩa tốt nhất là một liên minh địa phương gồm các chủ doanh nghiệp và doanh nghiệp được tổ chức để ủng hộ sự tăng trưởng kinh tế." },
            { text: "A news conference is characterized as a structured, interactive media event where organizational spokespersons deliver announcements and field questions from reporters.", textVi: "Họp báo được đặc trưng là một sự kiện truyền thông có cấu trúc và tính tương tác, nơi những người phát ngôn của tổ chức đưa ra thông báo và trả lời các câu hỏi từ phóng viên." },
            { text: "To manipulate market prices, the rival executives orchestrated a secret conspiracy to deliberately suppress competitive bidding.", textVi: "Để thao túng giá cả thị trường, các giám đốc điều hành đối thủ đã dàn dựng một âm mưu bí mật nhằm cố tình triệt tiêu đấu thầu cạnh tranh." },
            { text: "The executive board engaged in a highly illicit cover-up to obscure fraudulent accounting practices from external auditors and federal regulatory bodies.", textVi: "Ban điều hành đã tham gia vào một hành vi che giấu bất hợp pháp nghiêm trọng để giấu nhẹm các hành vi gian lận kế toán trước kiểm toán viên độc lập và các cơ quan quản lý liên bang." },
            { text: "When a prominent political figure abruptly shifts their stance on policy, they often serve as a dynamic catalyst, triggering a widespread paradigm shift in public sentiment.", textVi: "Khi một nhân vật chính trị nổi bật đột ngột thay đổi lập trường về chính sách, họ thường đóng vai trò như một chất xúc tác mạnh mẽ, châm ngòi cho sự dịch chuyển rộng rãi trong dư luận." },
            { text: "Social media is defined in modern PR as an ecosystem of web-based networks that facilitate interactive, user-generated content and peer-to-peer engagement.", textVi: "Mạng xã hội được định nghĩa trong PR hiện đại là một hệ sinh thái gồm các mạng lưới trên nền tảng web giúp tạo điều kiện thuận lợi cho nội dung tương tác do người dùng tạo ra và sự kết nối ngang hàng." },
            { text: "The logistics conglomerate faced a massive class-action lawsuit grounded in corporate negligence after failing to implement mandatory safety protocols.", textVi: "Tập đoàn logistics phải đối mặt với một vụ kiện tập thể khổng lồ dựa trên sự cẩu thả của doanh nghiệp sau khi không triển khai các quy trình an toàn bắt buộc." },
            { text: "Unlike statutory legal frameworks, common law is predominantly characterized as a system that evolves incrementally through judicial precedents.", textVi: "Không giống như các khung pháp lý thành văn, thông luật chủ yếu được đặc trưng là một hệ thống phát triển dần dần thông qua các án lệ của tòa án." },
            { text: "In corporate communication, targeted dissemination involves the systematic execution of message distribution to ensure critical information reaches specific institutional publics.", textVi: "Trong truyền thông doanh nghiệp, việc phổ biến thông tin có mục tiêu bao gồm việc thực hiện phân phối thông điệp một cách có hệ thống để đảm bảo thông tin quan trọng tiếp cận các nhóm công chúng tổ chức cụ thể." },
            { text: "For communication data to be classified as digital data, it must essentially be encoded in a binary format that computational processors can systematically interpret.", textVi: "Để dữ liệu truyền thông được phân loại là dữ liệu số, về cơ bản nó phải được mã hóa dưới dạng nhị phân mà các bộ xử lý máy tính có thể diễn giải một cách hệ thống." },
            { text: "In grassroots public affairs, a demonstration is strategically utilized as a highly visible public gathering intended to collectively protest a specific socio-political cause.", textVi: "Trong hoạt động đối ngoại quần chúng, một cuộc biểu tình tuần hành được sử dụng một cách chiến lược như một cuộc tập hợp công chúng trực quan nhằm tập thể phản đối một mục tiêu chính trị - xã hội cụ thể." },
            { text: "Modern PR practitioners must possess sharp business acumen, which is defined as the critical ability to make shrewd, commercially viable decisions that align with corporate profitability.", textVi: "Những người hành nghề PR hiện đại phải sở hữu sự nhạy bén trong kinh doanh sắc bén, được định nghĩa là năng lực quan trọng để đưa ra các quyết định sáng suốt, khả thi về mặt thương mại và phù hợp với mục tiêu lợi nhuận của doanh nghiệp." },
            { text: "The press secretary conducted a rapid-fire technical briefing to update journalists on the latest software integration and address security concerns.", textVi: "Thư ký báo chí đã tiến hành một buổi họp nhanh cung cấp thông tin kỹ thuật dồn dập để cập nhật cho các nhà báo về bản tích hợp phần mềm mới nhất và giải quyết các mối lo ngại về an ninh." },
            { text: "In digital PR history, the pejorative term brochureware refers to a flat, static website that merely mirrors printed promotional literature without offering interactive features.", textVi: "Trong lịch sử PR kỹ thuật số, thuật ngữ mang tính miệt thị brochureware dùng để chỉ một trang web tĩnh, phẳng, chỉ đơn thuần sao chép lại nội dung quảng cáo in ấn mà không cung cấp các tính năng tương tác." },
            { text: "Under defamation law, a critic's harsh but honest review of a new service is legally protected under the doctrine of fair comment, provided it lacks malicious intent.", textVi: "Theo luật phỉ báng, một bài đánh giá gay gắt nhưng trung thực của nhà phê bình về một dịch vụ mới được bảo vệ hợp pháp theo học thuyết bình luận công bằng, miễn là nó không có ý đồ xấu." },
            { text: "In response to systemic ethical violations within the supply chain, the international coalition urged global consumers to boycott the multinational corporation's products.", textVi: "Để phản đối các hành vi vi phạm đạo đức có hệ thống trong chuỗi cung ứng, liên minh quốc tế đã kêu gọi người tiêu dùng toàn cầu tẩy chay các sản phẩm của tập đoàn đa quốc gia." },
            { text: "Unsafely exposing private medical records or publishing non-newsworthy personal data about an executive without explicit consent constitutes an actionable invasion of privacy.", textVi: "Việc để lộ hồ sơ y tế cá nhân một cách không an toàn hoặc xuất bản dữ liệu cá nhân phi thời sự của một giám đốc điều hành mà không có sự đồng ý rõ ràng cấu thành hành vi xâm phạm quyền riêng tư có thể khởi kiện." },
            { text: "In corporate communication, a media tour is strategically designed as a series of scheduled engagements where an organizational representative travels to brief various media outlets.", textVi: "Trong truyền thông doanh nghiệp, chuyến du thuyết truyền thông được thiết kế chiến lược như một chuỗi các cuộc gặp đã được lên lịch sẵn, nơi đại diện tổ chức di chuyển đến nhiều địa điểm để trực tiếp cung cấp thông tin cho các cơ quan báo chí khác nhau." },
            { text: "To safeguard its unique brand identity from unauthorized commercial exploitation, the enterprise secured a registered trademark for its corporate logo and tagline.", textVi: "Để bảo vệ nhận diện thương hiệu độc đáo của mình khỏi bị khai thác thương mại trái phép, doanh nghiệp đã đăng ký bảo hộ nhãn hiệu cho logo và câu khẩu hiệu của công ty." },
            { text: "To ensure media outlets receive instantaneous updates, PR agencies frequently leverage RSS feeds to deliver breaking content directly to journalists' dashboards.", textVi: "Để đảm bảo các cơ quan truyền thông nhận được thông tin cập nhật tức thời, các công ty PR thường xuyên tận dụng các nguồn cấp dữ liệu RSS để truyền tải nội dung tin nóng trực tiếp đến bảng điều khiển của nhà báo." },
            { text: "The board appointed an experienced corporate relations director to serve as the official spokesperson during the delicate restructuring phase.", textVi: "Hội đồng quản trị đã chỉ định một giám đốc quan hệ doanh nghiệp giàu kinh nghiệm để làm người phát ngôn chính thức trong giai đoạn tái cấu trúc nhạy cảm." },
            { text: "To break the ice and humanize the corporate brand, the keynote speaker shared a compelling, brief anecdote about the company's humble beginnings.", textVi: "Để phá băng và nhân văn hóa thương hiệu doanh nghiệp, diễn giả chính đã chia sẻ một giai thoại ngắn đầy hấp dẫn về sự khởi đầu khiêm tốn của công ty." },
            { text: "A media alert is fundamentally structured as a concise, time-sensitive invitation detailing the who, what, when, where, and why to compel journalists to cover an upcoming event.", textVi: "Một thông báo truyền thông về cơ bản được cấu trúc như một thư mời ngắn gọn, khẩn thiết về thời gian, nêu chi tiết ai, cái gì, khi nào, ở đâu và tại sao để thúc đẩy các nhà báo đưa tin về một sự kiện sắp tới." },
            { text: "Internal legal counsel concluded that the subsidiary's aggressive offshore tax avoidance tactics, while ethically questionable, were entirely legitimate under current laws.", textVi: "Cố vấn pháp lý nội bộ kết luận rằng chiến thuật tránh thuế ngoại biên tích cực của công ty con, tuy đáng nghi ngờ về mặt đạo đức, nhưng hoàn toàn hợp pháp theo luật hiện hành." },
            { text: "The executive faces aggressive criminal prosecution after federal investigators uncovered definitive evidence of systemic insider trading.", textVi: "Giám đốc điều hành phải đối mặt với việc bị truy tố hình sự nghiêm trọng sau khi các điều tra viên liên bang phát hiện bằng chứng xác thực về giao dịch nội gián có hệ thống." },
            { text: "The highly polarizing environmental policy sparked a bitter controversy that deeply fractured the local community into two diametrically opposed factions.", textVi: "Chính sách môi trường gây chia rẽ sâu sắc đã dấy lên một cuộc tranh cãi gay gắt làm rạn nứt sâu sắc cộng đồng địa phương thành hai phe đối lập hoàn toàn." },
            { text: "The Chief Communications Officer initiated the high-stakes presentation by delivering a precise statement of purpose to align the stakeholders' expectations.", textVi: "Giám đốc Truyền thông đã bắt đầu buổi thuyết trình quan trọng bằng cách đưa ra một tuyên bố mục đích chính xác nhằm định hướng và thống nhất kỳ vọng của các bên liên quan." },
            { text: "To cultivate grassroots engagement in suburban districts, the campaign managers strategically distributed personalized postcards outlining the candidate's core manifesto.", textVi: "Để thúc đẩy sự tương tác cơ sở ở các khu vực ngoại ô, các nhà quản lý chiến dịch đã phân phối một cách chiến lược các bưu thiếp cá nhân hóa phác thảo bản tuyên ngôn cốt lõi của ứng cử viên." },
            { text: "In an era dominated by rapid-fire digital updates, PR specialists must tailor their content to accommodate an audience with a notoriously diminished attention span.", textVi: "Trong kỷ nguyên bị chi phối bởi các cập nhật kỹ thuật số dồn dập, các chuyên gia PR phải điều chỉnh nội dung của mình để thích ứng với nhóm đối tượng người nghe có khoảng thời gian chú ý bị rút ngắn đáng kể." },
        ],
    },
];
